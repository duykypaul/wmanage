<template>
  <div class="standard-table">
    <div class="alert">
      <a-alert type="info" :show-icon="true" v-if="selectedRows">
        <div class="message" slot="message">
          &nbsp;<a>{{selectedRows.length}}</a>&nbsp;items selected <a class="clear" @click="onClear">Clear</a>
    ...
    >
      <template slot-scope="text, record, index" :slot="slot" v-for="slot in Object.keys($scopedSlots).filter(id => id !== 'expandedRowRender') ">
