  ...
  children: [                               //root 路由的子路由配置
    ...
    },
    {
      ...
      children: [                           //form 路由的子路由配置
        'basic',                        //匹配 router.map.js 中注册名 registerName = basicForm 的路由
        'step',                         //匹配 router.map.js 中注册名 registerName = stepForm 的路由
        {
          router: 'advance',            //匹配 router.map.js 中注册名 registerName = advanceForm 的路由
          path: 'advance'                   //重写 advanceForm 路由的 path 属性
        }
      ]   
    },
    {
      router: 'basic',                  //匹配 router.map.js 中注册名 registerName = basicForm 的路由
